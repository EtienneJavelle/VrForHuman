...
namespace RockVR.Video {
    ...
    public class AudioCapture : MonoBehaviour {
        ...
        private static extern System.IntPtr AudioCaptureLib_Get(int rate, string path, string ffpath);

        [DllImport("VideoCaptureLib")]
        private static extern void AudioCaptureLib_WriteFrame(System.IntPtr api, byte[] data);

        [DllImport("VideoCaptureLib")]
        private static extern void AudioCaptureLib_Close(System.IntPtr api);

        [DllImport("VideoCaptureLib")]
        private static extern void AudioCaptureLib_Clean(System.IntPtr api);
        #endregion
    }
}